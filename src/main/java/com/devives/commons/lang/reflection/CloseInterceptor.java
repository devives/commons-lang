...
public class CloseInterceptor<T> implements InvocationHandler {
    ...
    private final FailableProcedure1<T, Exception> closeHandler_;
     ...
     */
    public static <T> T build(T closeable, FailableProcedure1<T, Exception> closeHandler) {
        try {
    ...
    private CloseInterceptor(T closeable, FailableProcedure1<T, Exception> closeHandler) {
