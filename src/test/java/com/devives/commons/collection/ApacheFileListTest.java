...
public class ApacheFileListTest<E> extends ApacheAbstractListTest {
    ...
    public List<E> makeObject() {
        return ExceptionUtils.passChecked(() -> {
            FileList fileList = FileList.of(new ObjectBinarySerializer(128)).setFileByteStore(tempPath).build();
