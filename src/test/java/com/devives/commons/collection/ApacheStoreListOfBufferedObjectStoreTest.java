...
public class ApacheStoreListOfBufferedObjectStoreTest<E> extends ApacheAbstractListTest {
    ...
    public List<E> makeObject() {
        return ExceptionUtils.passChecked(() -> {
            ...
            Store<E> mainSerializedStore = new SerializedStore<>(binarySerializer, alignedByteStore);
            BufferedObjectStore<E> bufferedSerializedStore = new BufferedObjectStore<>(mainSerializedStore);
            bufferedSerializedStore.setBufferSize(2);
            StoreList<E> list = new StoreList(bufferedSerializedStore);
            return list;
        });
    }
