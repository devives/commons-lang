...
public class FileListTest<E> extends TempDirectoryTestBase {

    @Test
    public void test() throws Exception {
        int i;
        List<Object> list = SerializedLists.of(new ObjectBinarySerializer(128)).setFileStorePath(tempPath).build();
...
//    }
    ...
    public void test4() throws Exception {
        List<Object> list = SerializedLists.of(new ObjectBinarySerializer(100)).setFileStorePath(tempPath).build();
    ...
    public void test5() throws Exception {
        List<Long> list = SerializedLists.ofLongs().setFileStorePath(tempPath).build();
        List<Long> testData = new ArrayList<>(Arrays.asList(111L, 222L, 333L));
        list.addAll(testData);
        Assertions.assertEquals(111L, list.get(0));
        Assertions.assertEquals(222L, list.get(1));
