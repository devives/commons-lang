...
public class ApacheBufferedListOfFileStoreTest<E> extends ApacheAbstractListTest {
    ...
    public List<E> makeObject() {
        return ExceptionUtils.passChecked(() -> {
            ...
            BufferedStoreAsListAdapter<E> list = new BufferedStoreAsListAdapter<E>(new BufferedObjectStore<E>(serializedStore));
